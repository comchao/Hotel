...
<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark "
    ...
    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
        @foreach(config('mainmenu') as $menu)
                ...
                <li class="m-menu__item m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover">
                    ...
                    <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                        <ul class="m-menu__subnav">
                            <li class="m-menu__item  m-menu__item--parent" aria-haspopup="true"><span class="m-menu__link"><span class="m-menu__link-text">{{$menu['title']}}</span></span></li>
                            @foreach($submenu as $sub)
                                <li id="m-menu__item--{{$sub['url']}}" class="m-menu__item {{ (starts_with(\Illuminate\Support\Facades\Route::currentRouteName(),$sub['url']) || ($menu['url'] == 'manage' && $sub['url'] == 'project' && starts_with(\Illuminate\Support\Facades\Route::currentRouteName(), ["project", "building", "room"]))) ? 'm-menu__item--active' : '' }}  " aria-haspopup="true">
            ...
            @else
                <li class="m-menu__item {{ starts_with(\Illuminate\Support\Facades\Route::currentRouteName(),$menu['url']) ? 'm-menu__item--active' : '' }}" aria-haspopup="true">
