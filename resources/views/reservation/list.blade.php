                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8"><input id="datenewbooking" class="form-control" width="213" /></div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                        ...
                        <div class="col-sm-4"><div class="container">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8"><input id="datepicker_chkIn" class="form-control" width="206" /></div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4 col-form-label">Check out</label>
                                        <div class="col-sm-8"><input id="datepicker_chkOut" class="form-control" width="206" /></div>
                                    </div>
                                    <div class="form-group row">
